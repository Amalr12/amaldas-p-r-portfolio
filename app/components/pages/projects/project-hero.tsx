   ...
   return (
      <div className="text-center mt-20 md:mt-15">
         ...
         <div className="grid gap-8 md:m-10 m-5 sm:grid-cols-2 lg:grid-cols-[2fr_4fr] md:grid-cols-[2fr_4fr] grid-cols-1 justify-around items-center">
            <div className="group relative h-[20rem] overflow-hidden rounded-xl hover:cursor-pointer border border-xl">
               ...
               <div className="absolute z-20 inset-0 flex items-center justify-center flex flex-col opacity-0 transition duration-300 group-hover:opacity-100">
                ...
                <div className="flex gap-4 md:hidden  text-center z-30 absolute bottom-4 right-4 text-white">
                     <Link href={"https://propertyease1.vercel.app/"}>
                        <button className="rounded-full bg-black px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-white hover:text-black cursor-pointer">
                           <ArrowUpRight />
                        </button>
         ...
         <div className={`text-xl text-gray-300 ${sen.className} m-5 md:m-10 grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-4 justify-around items-center`}>
            ...
            <div className="group relative h-[20rem] overflow-hidden rounded-xl">
               ...
               <div className="absolute z-20 inset-0 flex items-center justify-center flex flex-col opacity-0 transition duration-300 group-hover:opacity-100">
                  ...
                  <div className="flex gap-4 justify-between items-center">
                     <Link href={"https://events-frontend-dusky.vercel.app"}>
                        <button className="rounded-full bg-black px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-white hover:text-black cursor-pointer">
                           <ArrowUpRight />
                        </button>
                     </Link >
