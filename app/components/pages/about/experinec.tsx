        ...
        <div>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3  items-center p-10 rounded-2xl bg-gray-900/20 mb-5" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <div className="flex flex-col ps-5">
                        <h1 className={`text-lg font-bold md:text-xl ${onest.className}`} data-aos="fade-up" data-aos-delay="250">Frontend Developer</h1>
                    ...
                    <div className="flex flex-col ps-5">
                        <h1 className={`text-lg font-bold md:text-xl ${onest.className}`} data-aos="fade-up" data-aos-delay="250">Reference</h1>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3  items-center p-10 rounded-2xl bg-gray-900/20 mb-5" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <div className="flex flex-col ps-5">
                        <h1 className={`text-lg font-bold md:text-xl ${onest.className}`} data-aos="fade-up" data-aos-delay="250">Mearn Full Stack Intern</h1>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3  items-center p-10 rounded-2xl bg-gray-900/20 mb-5" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <div className="flex flex-col ps-5">
                        <h1 className={`text-lg font-bold md:text-xl ${onest.className}`} data-aos="fade-up" data-aos-delay="250">Resident Engineer</h1>
